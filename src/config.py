...
GOAL_ANALYST_DRIVER = os.getenv("GOAL_ANALYST_DRIVER", "")
GOAL_ANALYST_MODEL = os.getenv("GOAL_ANALYST_MODEL", "")
GOAL_ANALYST_API_KEY = os.getenv("GOAL_ANALYST_API_KEY", "")
GOAL_ANALYST_TEMPERATURE = float(os.getenv("GOAL_ANALYST_TEMPERATURE", "0.0"))
GOAL_ANALYST_MAX_TOKENS = int(os.getenv("GOAL_ANALYST_MAX_TOKENS", "96"))
GOAL_ANALYST_TIMEOUT = float(os.getenv("GOAL_ANALYST_TIMEOUT", "12.0"))
